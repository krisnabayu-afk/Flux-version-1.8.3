...
import DepartmentManagement from './pages/DepartmentManagement'; // NEW: SuperUser department management
import TTB from './pages/TTB'; // NEW: TTB Document Archive
      ...
      <NotificationProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/ttb" element={<ProtectedRoute><TTB /></ProtectedRoute>} /> {/* NEW: TTB Document Archive */}
            ...
            <Route path="/departments" element={<ProtectedRoute><DepartmentManagement /></ProtectedRoute>} /> {/* SuperUser only */}
