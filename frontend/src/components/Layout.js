...
import { Bell, Calendar, FileText, Ticket, LayoutDashboard, LogOut, User, MapPin, UserCheck, Settings, Menu, ClipboardCheck, Tag, Users, BarChart, Satellite, History, Send, AlertCircle, FileArchive } from 'lucide-react';
...
const Layout = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/ttb', label: 'TTB', icon: FileArchive }, // TTB Document Archive
            ...
            <div className="flex items-center space-x-3">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  {/* Department Management - Only for SuperUser */}
                  {user?.role === 'SuperUser' && (
                    <DropdownMenuItem onClick={() => navigate('/departments')} data-testid="departments-menu">
