                  ...
                  <div className="pt-4 border-t">
                    ...
                    {selectedReport.final_score != null && (
                      <div className="mt-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 flex items-center justify-between">
                        <span className="text-sm font-semibold text-yellow-600 dark:text-yellow-400">Final Score</span>
                        <div className="flex items-center gap-1">
                          ...
                          <span className="ml-2 text-lg font-bold text-yellow-600 dark:text-yellow-400">{selectedReport.final_score.toFixed(1)}</span>
                        </div>
                      </div>
                    )}
                  </div>
