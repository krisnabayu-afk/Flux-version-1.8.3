                    ...
                    <>
                        <div className="max-h-[160px] overflow-y-auto space-y-0.5">
                            {openTickets.slice(0, 5).map((ticket, index) => (
                                <div key={ticket.id} className={`p-3 bg-white ${index === 0 ? 'rounded-t-xl' : ''} ${index === openTickets.slice(0, 5).length - 1 ? 'rounded-b-xl' : ''} border-b border-gray-50 last:border-b-0 flex items-center justify-between`}>
